...
$rs = mysql_query( "select * from EpRegUsrTbl",$conn); //这里有第二个可选参数，指定打开的连接
//-----------------------------------------------------------------------------------------------//
//分页逻辑处理
//-----------------------------------------------------------------------------------------------
...
//↓读取指定记录数
$result=mysql_query("select * from EpRegUsrTbl order by UserId limit $offset,$pagesize",$conn);//取得—当前页—记录集！DateTime
...
while($row = mysql_fetch_array($result))
{
  ...
  $UserName  = iconv("GB2312","UTF-8//IGNORE",$row['UserName']);
  $Pwd  = iconv("GB2312","UTF-8//IGNORE",$row['Pwd']);
  //$LocalIp  = iconv("GB2312","UTF-8//IGNORE",$row['LocalIp']);
  //$NatType  = iconv("GB2312","UTF-8//IGNORE",$row['NatType']);
  
  echo "<tr>";
                                                                       
  echo "<td width=\"100px\" align=\"center\">" . $row['UserId'] . "</td>";  
  echo "<td width=\"100px\" align=\"center\">" . $UserName . "</td>";  
  echo "<td width=\"100px\" align=\"center\">" . $row['Pwd'] . "</td>";  
  echo "<td width=\"100px\" align=\"center\">" . $row['PhoneNum'] . "</td>";  
  echo "<td width=\"100px\" align=\"center\">" . $row['PortraitId'] . "</td>";  
  if ($row['Roll'] == 1)  
  {
  	echo "<td width=\"100px\" align=\"center\">学生1</td>"; 
  }
  else if ($row['Roll'] == 2)
  {
  	echo "<td width=\"100px\" align=\"center\">老师2</td>"; 
  }
  echo "<td width=\"100px\" align=\"center\">" . $row['LocalIp'] . "</td>";  
  echo "<td width=\"100px\" align=\"center\">" . $row['LocalPort'] . "</td>";
  echo "<td width=\"100px\" align=\"center\">" . $row['PubIp'] . "</td>";  
  echo "<td width=\"100px\" align=\"center\">" . $row['PubPort'] . "</td>";    
  echo "<td width=\"100px\" align=\"center\">" . $row['PhoneModel'] . "</td>";
  echo "<td width=\"100px\" align=\"center\">" . $row['Mac'] . "</td>";
  echo "<td width=\"100px\" align=\"center\">" . $row['DateTime'] . "</td>";
  echo "<td width=\"100px\" align=\"center\">" . $row['ActionNum'] . "</td>";
  echo "<td width=\"100px\" align=\"center\">" . $row['NatType'] . "</td>";  
/*

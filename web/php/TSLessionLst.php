...
<h1 align="center">Teacher student lession list</h1>
</td>
</tr>
...
$rs = mysql_query( "select * from TSLessionTbl, LessionDescTbl, ExerciseDescTbl where TSLessionTbl.LessionId = LessionDescTbl.LessionId and (LessionDescTbl.ExerciseId1 = ExerciseDescTbl.ExerciseId or LessionDescTbl.ExerciseId2 = ExerciseDescTbl.ExerciseId);",$conn); //这里有第二个可选参数，指定打开的连接
//-----------------------------------------------------------------------------------------------//
//分页逻辑处理
//-----------------------------------------------------------------------------------------------
...
//↓读取指定记录数
$result=mysql_query("select * from TSLessionTbl, LessionDescTbl, ExerciseDescTbl where TSLessionTbl.LessionId = LessionDescTbl.LessionId and (LessionDescTbl.ExerciseId1 = ExerciseDescTbl.ExerciseId or LessionDescTbl.ExerciseId2 = ExerciseDescTbl.ExerciseId) order by concat(TeacherUserId, StudentUserId, ScheduleTime,TSLessionTbl.LessionId)  limit $offset,$pagesize",$conn);//取得—当前页—记录集！DateTime
...
while($row = mysql_fetch_array($result))
{
  ...
  echo "<td width=\"100px\" align=\"center\">" . $row['ScheduleTime'] . "</td>";
    
  echo "<td width=\"100px\" align=\"center\">" . $row['LessionId'] . "</td>";
                                                                       
  //echo "<td width=\"100px\" align=\"center\">" . $row['EstablishTime'] . "</td>";
  echo "<td width=\"100px\" align=\"center\">" . $row['SongId'] . "</td>";
/*

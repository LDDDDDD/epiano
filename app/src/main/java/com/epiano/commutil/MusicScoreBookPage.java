...
public class MusicScoreBookPage extends FrameLayout {
	...
	public MusicScoreBookPage(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public MusicScoreBookPage(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		mContext = context;
		viewInit();
	...
	private class FingerTouchListener implements OnTouchListener {
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			if (v == MusicScoreBookPage.this && mAdapter != null) {
				if (event.getAction() == MotionEvent.ACTION_DOWN) {
					...
					mTouch.x = event.getX();
					mTouch.y = event.getY();
					MusicScoreBookPage.this.postInvalidate();

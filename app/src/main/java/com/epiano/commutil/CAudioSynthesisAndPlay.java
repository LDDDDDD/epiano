...
public class CAudioSynthesisAndPlay {
	...
	MusicScoreBook3D.PosIndicateTask IndiTask;
...
//					+ ", t:" + PlayDataSize / (16));
	...
	// 构造函数
	public CAudioSynthesisAndPlay(String openfilenameIn, ProgressBar pbIn, int StereoOnIn) //, CKeyAudio KeyAudio[])
	{
